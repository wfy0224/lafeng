...
public class MQListener {
    ...
    @RabbitListener(queues = "gc_record_export_task_id")
    protected void execute(BigInteger taskId, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) {
